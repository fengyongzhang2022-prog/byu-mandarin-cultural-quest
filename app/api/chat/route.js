...
const PROMPTS = {
  ...
  green_editor: `你是中文听说课的讲述教练。学习者已经按时间整理了事情的开始、5000美元的直接作用和后来的长期变化。请帮助学习者准备下一次口头讲述，严格只返回一行“一句话回答｜事情经过｜表达提示”，不要使用Markdown、星号、项目符号或字段标签。“一句话回答”直接说明5000美元帮助购买树苗，但森林还来自长期行动、技术和治理；“事情经过”按“1985年开始→1999年得到帮助→此后二十多年继续”组织；“表达提示”给出一个自然的连接词建议。每一项不超过45个汉字。`,
...
function fallback(stage, role, message = "") {
  ...
  if (stage === "green_editor") return "5000美元帮助购买了树苗，但森林还来自长期治沙｜1985年开始治沙→1999年得到捐款帮助→此后二十多年继续补种和调整｜用“不过”和“后来”说清捐款前后的变化";
...
export async function POST(request) {
  ...
  const context = [
    ...
    body?.causeMap && typeof body.causeMap === "object" ? `学习者整理的时间信息：${clean(JSON.stringify(body.causeMap), 120)}` : "",
